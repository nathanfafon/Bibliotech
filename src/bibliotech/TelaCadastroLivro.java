...
public class TelaCadastroLivro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtTitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 40, 160, 20));
        getContentPane().add(txtAutor, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 80, 160, -1));
        getContentPane().add(txtEditora, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 120, 160, -1));
    ...
    try {
    // 1. Pegamos o que o usuário digitou nas caixinhas [cite: 14, 20]
    String titulo = txtTitulo.getText();
    String autor = txtAutor.getText();
    String editora = txtEditora.getText();

    // 2. Chamamos o DAO para salvar de verdade no MySQL [cite: 19]
    LivroDAO dao = new LivroDAO();
    dao.cadastrarLivro(titulo, autor, editora);

    // 3. Avisamos que deu certo
    javax.swing.JOptionPane.showMessageDialog(this, "Livro cadastrado com sucesso no banco!");
